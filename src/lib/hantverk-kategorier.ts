...
export const HANTVERK_KATEGORIER: ReadonlyArray<HantverkKategori> = [
  ...
  },
  {
    ...
    ng1: [43120, 43110, 42110, 42120, 42210, 42220, 42910, 42990, 28220],
    count: 11100,
    icon: Mountain,
  },
  {
  ...
  },
  {
    ...
    ng1: [43320, 16239, 16233, 25120, 25720],
    count: 10006,
    icon: Hammer,
  },
  {
  ...
  },
  {
    slug: "sanering-stad",
    name: "Sanering & städ",
    description: "Lokalvård, fasadtvätt, sanering, fönsterputs",
    ng1: [81290, 81210, 81221],
    count: 6470,
    icon: SprayCan,
  },
  {
