...
/** Slå upp upp till 3 branschnamn som matchar query — endast inom hantverks-nischen. */
...
/**
 * Instant-suggest — alla resultat ligger inom hantverks-nischen.
 *  1) Kommunnamn matchas in-memory (290 st — billigt).
 *  2) Populära branscher matchas in-memory + DB-uppslag (filtrerat på whitelist).
 *  3) Företag matchas via `search_vector` filtrerat på HANTVERK_BRANSCHER.
 */
export async function GET(req: Request) {
  ...
  // 3. Företag via search_vector — alltid filtrerat på hantverks-nischen.
